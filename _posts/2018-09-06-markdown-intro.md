...
```
行内式 [博客](https://www.scarypie.club "我的个人博客") 链接，带 title。
...
```html
<p>行内式 <a href="https://www.scarypie.club" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/mzlogin">GitHub</a> 链接。</p>

<p>引用式 <a href="https://www.scarypie.club">博客</a> 链接。</p>
...
```
![Alt text](https://www.scarypie.club/favicon.ico "favicon")
```
...
```html
<img src="https://www.scarypie.club/favicon.ico" alt="Alt text" title="favicon">
```
...
另外可以参考我以前的一篇博客 [关于 Markdown 的一些奇技淫巧](https://www.scarypie.club/2017/09/01/markdown-odd-skills/)。
...
* [关于 Markdown 的一些奇技淫巧](https://www.scarypie.club/2017/09/01/markdown-odd-skills/)
